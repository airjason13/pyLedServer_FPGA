...
from ui.ui_system_page import SystemPage

'''List of Page Selector Button Name '''
Page_Select_Btn_Name_List = ["FPGA_List", "Media_Files", "HDMI_In", "CMS", "Led_Settings", "System", "Test"]
Page_List = [FpgaListPage, MediaFilesPage, HDMIInPage, CMSPage, LedSettingsPage, SystemPage, TestPage]
